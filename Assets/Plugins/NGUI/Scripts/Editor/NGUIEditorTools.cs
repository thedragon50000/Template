...
static public class NGUIEditorTools
{
    ...
    private static Texture2D CreateCheckerTex(Color c0, Color c1)
    {
        ...
        for (int iy = 0; iy < 8; ++iy)
        {
            ...
            for (int ix = 0; ix < 8; ++ix)
            {
                ...
                for (int y = 0; y < 8; ++y)
                for (int x = 0; x < 8; ++x)
                    tex.SetPixel(ox + x, oy + y, c1);
                for (int y = 8; y < 16; ++y)
                for (int x = 0; x < 8; ++x)
                    tex.SetPixel(ox + x, oy + y, c0);
                for (int y = 0; y < 8; ++y)
                for (int x = 8; x < 16; ++x)
                    tex.SetPixel(ox + x, oy + y, c0);
                for (int y = 8; y < 16; ++y)
    ...
    static public string DrawAdvancedList(string field, string[] list, string selection, params GUILayoutOption[] options)
    {
        if (list != null && list.Length > 0)
        {
            ...
            // Draw the sprite selection popup
            index = string.IsNullOrEmpty(field) ? DrawPrefixList(index, list, options) : DrawPrefixList(field, index, list, options);
    ...
    static public GameObject SelectedRoot(bool createIfMissing)
    {
        ...
        if (createIfMissing && go == null)
        {
            ...
            if (go == null)
            {
                UIPanel panel = Object.FindFirstObjectByType(typeof(UIPanel)) as UIPanel;
    ...
    static public Texture2D ImportTexture(string path, bool forInput, bool force, bool alphaTransparency)
    {
        if (!string.IsNullOrEmpty(path))
        {
            if (forInput)
            {
                if (!MakeTextureReadable(path, force)) return null;
            }
    ...
    /// </summary>
    static public void DrawSpriteField(string label, INGUIAtlas atlas, string spriteName, SpriteSelector.Callback callback,
    ...
    /// Draw a sprite selection field.
    /// </summary>
    static public void DrawPaddedSpriteField(string label, INGUIAtlas atlas, string spriteName, SpriteSelector.Callback callback,
        params GUILayoutOption[] options)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Label(label, GUILayout.Width(76f));
    ...
    /// Draw a sprite selection field.
    /// </summary>
    static public void DrawSpriteField(string label, string caption, INGUIAtlas atlas, string spriteName,
    ...
    /// </summary>
    static public bool DrawSpriteField(INGUIAtlas atlas, string spriteName, SpriteSelector.Callback callback,
        params GUILayoutOption[] options)
    {
        if (atlas.GetSprite(spriteName) == null) spriteName = "";
    ...
    /// Draw a sprite selection field.
    /// </summary>
    static public void DrawSpriteField(string label, SerializedObject ob, SerializedProperty atlas, SerializedProperty sprite,
        params GUILayoutOption[] options)
    {
    ...
    /// </summary>
    static public void DrawSpriteField(string label, SerializedObject ob, SerializedProperty atlas, SerializedProperty sprite,
        bool removable, params GUILayoutOption[] options)
    {
    ...
    /// </summary>
    static public void DrawSpriteField(string label, SerializedObject ob, SerializedProperty atlas, SerializedProperty sprite,
        float width, bool padded, bool removable, params GUILayoutOption[] options)
    {
    ...
    /// Convenience function that displays a list of sprites and returns the selected value.
    /// </summary>
    static public void DrawAdvancedSpriteField(INGUIAtlas atlas, string spriteName, SpriteSelector.Callback callback, bool editable,
        params GUILayoutOption[] options)
    {
        if (atlas == null) return;
    ...
    /// </summary>
    static public SerializedProperty DrawProperty(this SerializedObject serializedObject, string property,
        params GUILayoutOption[] options)
    {
    ...
    /// Helper function that draws a serialized property.
    /// </summary>
    static public SerializedProperty DrawProperty(this SerializedObject serializedObject, string property, string label,
        params GUILayoutOption[] options)
    {
    ...
    /// Helper function that draws a serialized property.
    /// </summary>
    static public SerializedProperty DrawPaddedProperty(this SerializedObject serializedObject, string property,
        params GUILayoutOption[] options)
    {
    ...
    /// Helper function that draws a serialized property.
    /// </summary>
    static public SerializedProperty DrawPaddedProperty(string label, SerializedObject serializedObject, string property,
        params GUILayoutOption[] options)
    {
    ...
    /// Helper function that draws a serialized property.
    /// </summary>
    static public SerializedProperty DrawProperty(string label, SerializedObject serializedObject, string property, bool padding,
        params GUILayoutOption[] options)
    {
    ...
    static public void UpgradeTexturesToSprites(INGUIAtlas atlas)
    {
        ...
        if (uits.Count > 0)
        {
            var selectedTex = (UIWidgetInspector.instance != null && UIWidgetInspector.instance.target != null)
                ? UIWidgetInspector.instance.target as UITexture
                : null;
        ...
        {
            var selectedTex = (UIWidgetInspector.instance != null && UIWidgetInspector.instance.target != null)
                ? UIWidgetInspector.instance.target as UI2DSprite
                : null;
    ...
    static public Object GUIDToObject(string guid)
    {
        ...
        if (s_GetInstanceIDFromGUID == null)
        {
            ...
            // Unity 2018+
            if (s_GetInstanceIDFromGUID == null)
                s_GetInstanceIDFromGUID = type.GetMethod("GetMainAssetInstanceID", BindingFlags.Static | BindingFlags.NonPublic);
    ...
    private static System.Collections.Generic.Dictionary<string, TextureImporterType> mOriginal =
